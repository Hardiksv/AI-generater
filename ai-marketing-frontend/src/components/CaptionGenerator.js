...
const CaptionGenerator = ({ goBack }) => {
  ...
  const handleGenerate = async () => {
    setLoading(true);
    try {
      const response = await fetch("https://ai-generater-1.onrender.com/api/caption", {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f5f7fa] via-[#e4ecf2] to-[#d4dce5] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 relative w-full max-w-6xl z-10">
        ...
        >
          ...
          >
            Generate Captivating Captions
          </motion.h2>

          <p className="text-gray-500 text-center mb-6">
            Perfect for social media, branding, or product marketing.
          </p>
          ...
          {captions.length > 0 && (
            <motion.div
              ...
              className="mt-6"
            >
              <h3 className="font-semibold text-gray-700 mb-2">Generated Captions:</h3>
